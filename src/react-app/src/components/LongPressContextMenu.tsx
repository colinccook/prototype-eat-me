  ...
  return (
    ...
    >
      ...
      >
        ...
        <button className="context-menu-item flex items-center gap-3 w-full px-4 py-[0.85rem] border-0 bg-transparent text-[0.9rem] font-medium text-gray-800 cursor-pointer text-left min-h-[44px] hover:bg-[#f5f5ff] active:bg-[#e8e8ff] border-t border-gray-100 first:border-t-0" onClick={handleShare}>
        ...
        {onFavouriteItem && (
          <button className="context-menu-item flex items-center gap-3 w-full px-4 py-[0.85rem] border-0 bg-transparent text-[0.9rem] font-medium text-gray-800 cursor-pointer text-left min-h-[44px] hover:bg-[#f5f5ff] active:bg-[#e8e8ff] border-t border-gray-100" onClick={handleFavouriteItem}>
            <svg className="shrink-0 text-[#667eea]" viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        {onHideItem && (
          <button className="context-menu-item flex items-center gap-3 w-full px-4 py-[0.85rem] border-0 bg-transparent text-[0.9rem] font-medium text-gray-800 cursor-pointer text-left min-h-[44px] hover:bg-[#f5f5ff] active:bg-[#e8e8ff] border-t border-gray-100" onClick={handleHideItem}>
            <svg className="shrink-0 text-[#667eea]" viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        {restaurantName && onHideRestaurant && (
          <button className="context-menu-item flex items-center gap-3 w-full px-4 py-[0.85rem] border-0 bg-transparent text-[0.9rem] font-medium text-gray-800 cursor-pointer text-left min-h-[44px] hover:bg-[#f5f5ff] active:bg-[#e8e8ff] border-t border-gray-100" onClick={handleHideRestaurant}>
            <svg className="shrink-0 text-[#667eea]" viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              <path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94"/>
              <path d="M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19"/>
              <line x1="1" y1="1" x2="23" y2="23"/>
        ...
        {restaurantName && onOnlyShowRestaurant && (
          <button className="context-menu-item flex items-center gap-3 w-full px-4 py-[0.85rem] border-0 bg-transparent text-[0.9rem] font-medium text-gray-800 cursor-pointer text-left min-h-[44px] hover:bg-[#f5f5ff] active:bg-[#e8e8ff] border-t border-gray-100" onClick={handleOnlyShowRestaurant}>
            <svg className="shrink-0 text-[#667eea]" viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
